...
import com.rest.example.employeeservices.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public Employee updateEmployeeById(Long id, Employee employee) {
        ...
        if (employee1.isPresent()) {
            ...
            if (Objects.nonNull(employee.getEmployeeRole()) && !"".equalsIgnoreCase(employee.getEmployeeName())) {
